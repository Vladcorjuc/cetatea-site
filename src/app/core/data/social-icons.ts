// Shared SVG path data for social network icons, keyed by RetelSociala.nume.
// Used by both the footer and the home hero.
export const ICOANE_RETELE: Record<string, string> = {
