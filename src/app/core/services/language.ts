...
const DICTIONARY: Record<Lang, Record<string, string>> = {
  ro: {
    ...
    'nav.doneaza': 'Donează',
    'doneaza.eyebrow': 'Sprijină lucrarea',
    'doneaza.doneazaCuCardul': 'Donează cu cardul',
    'doneaza.sauPrinTransfer': 'Sau prin transfer bancar',
    'doneaza.numeCont': 'Nume cont',
    'doneaza.banca': 'Bancă',
    'doneaza.copiaza': 'Copiază',
    'doneaza.copiat': 'Copiat ✓',
    'doneaza.deschidePaypal': 'Donează prin PayPal',
    'doneaza.deschideRevolut': 'Donează prin Revolut',
  ...
  en: {
    ...
    'nav.doneaza': 'Donate',
    'doneaza.eyebrow': 'Support the ministry',
    'doneaza.doneazaCuCardul': 'Give by card',
    'doneaza.sauPrinTransfer': 'Or by bank transfer',
    'doneaza.numeCont': 'Account name',
    'doneaza.banca': 'Bank',
    'doneaza.copiaza': 'Copy',
    'doneaza.copiat': 'Copied ✓',
    'doneaza.deschidePaypal': 'Give via PayPal',
    'doneaza.deschideRevolut': 'Give via Revolut',
    'footer.contact': 'Contact',
